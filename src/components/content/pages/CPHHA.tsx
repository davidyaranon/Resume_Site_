      ...
      <div ref={pageRef} className="component-container" id='CPHHA'>
        <div className="content-wrapper">
          <div className="text-area">
            ...
            <br />
            <p>
              Here I am using photogrammetry techniques to model local Humboldt plants and have built an accompanying website to display the corresponding information.
            </p>
            <br />
            <p>
              Check out one of the models I built on the embedded model viewer!
            </p>
            <br />
            ...
            <br />
            <p>
              <a className={context.currPage} href="https://nrs-projects.humboldt.edu/~ab632/src/html/" target='_blank' rel="noopener noreferrer">Visit Beta Site</a>
              &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
              <a className={context.currPage} href="https://cph-3d-digital-herbarium.firebaseapp.com/" target='_blank' rel="noopener noreferrer">Visit Responsive Site</a>
            </p>
          </div>
          <div className="image-area">
            <div className="iframe-wrapper">
              <iframe frameBorder="0" height='100%' width='100%' id="model-viewer" title={"Model Viewer"}
                ...
                allowFullScreen src="https://sketchfab.com/models/ae64a3739dfc4fa1a86171e120f18494/embed?autostart=1"
              />
            </div>
          </div>
        </div>
